...
function fnExcelReport(tableId, filename) {
    ...
    else saveContent('data:application/vnd.ms-excel,' + encodeURIComponent(tab_text), filename + '.xls')
...
var tableToExcel = (function () {
    ...
    return function (table, name) {
        ...
        saveContent(uri + base64(format(template, ctx)), name + '.xls')
    }
})()

function saveContent(href, fileName) {
