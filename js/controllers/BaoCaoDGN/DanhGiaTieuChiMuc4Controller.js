angular.module('WebApiApp').controller('DanhGiaTieuChiMuc4Controller', ['$rootScope', '$scope', '$http', '$cookies', '$uibModal', '$settings', 'FactoryConstant', function ($rootScope, $scope, $http, $cookies, $uibModal, $settings, FactoryConstant) {
    ...
    $scope.OpenModalBaoCao = function (item, type) {
        $scope.modalInstance = $uibModal.open({
            ariaLabelledBy: 'modal-title',
            animation: true,
            ariaDescribedBy: 'modal-body',
            templateUrl: 'views-client/template/BaoCaoDGN/DGTieuChiMuc4/ModalDGTieuChiMuc4.html?bust=' + Math.random().toString(36).slice(2),
            controller: 'ModalBaoCaoDGTieuChiMuc4',
            controllerAs: 'vm',
            scope: $scope,
            backdrop: 'static',
            size: 'full',
...
angular.module('WebApiApp').
    controller("ModalKeHoachDGN", function ($rootScope, $scope, $http, $uibModalInstance, FactoryConstant, $uibModal) {
...
angular.module('WebApiApp').
    controller("ModalBaoCaoDGTieuChiMuc4", function ($rootScope, $scope, $http, $uibModalInstance, FactoryConstant, $uibModal) {
    $scope.item = $scope.$resolve.item;
    $scope.type = $scope.$resolve.type;
    ...
    $scope.OnChangeTieuChuan = function (Id) {
        $scope.TieuChis = []
